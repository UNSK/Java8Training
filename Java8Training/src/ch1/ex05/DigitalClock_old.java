 ...
 */
public class DigitalClock_old extends Frame implements Runnable {
    /** serial version */
    ...
    public void paint(Graphics g) {
        ...
        if (isTimerRun) {
            g.drawString("Timer " + ((Integer) timerRemain--) + " sec", 200,
                    100);
        } else {
            g.drawString("      " + ((Integer) timerRemain) + " sec", 200, 100);
        }
    }
